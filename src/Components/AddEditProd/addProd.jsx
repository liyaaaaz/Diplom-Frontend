...
export const AddProd = ({ closeModal, fetchAgain }) => {
  ...
  const handleFileChange = async (event) => {
    ...
    for (const file of files) {
      ...
      await fetch(
        "https://api.cloudinary.com/v1_1/8rg4aKYAJXt8JYpXYZliC34tZlc/image/upload",
        {
          method: "POST",
          body: formData,
        }
          ...
          >
            {formik.values.subcategory.category === "Dry building mixtures"
              ? [
                  ...
                  <MenuItem key="Клей плиточный" value="Клей плиточный">
                    Клей плиточный
                  </MenuItem>,
                  <MenuItem key="Наливной пол" value="Наливной пол">
                    Наливной пол
                  </MenuItem>,
                  <MenuItem key="Стяжка" value="Стяжка">
                    Стяжка
                  </MenuItem>,
                  <MenuItem key="Клей для газоблока" value="Клей для газоблока">
                    Клей для газоблока
                  </MenuItem>,
                  <MenuItem key="Кладочная смесь" value="Кладочная смесь">
                    Кладочная смесь
                  </MenuItem>,
                ]
              : null}
            ...
            {formik.values.subcategory.category === "Primers"
              ? [
                  <MenuItem key="Грунтовки" value="Грунтовки">
                    Грунтовки
                  </MenuItem>,
                  <MenuItem key="Бетоноконтакт" value="Бетоноконтакт">
                    Бетоноконтакт
                  </MenuItem>,
                  <MenuItem key="Пропитка" value="Пропитка">
                    Пропитка
                  </MenuItem>,
                ]
              : null}
            ...
            "Ready-made building mixtures"
              ? [
                  ...
                  <MenuItem key="Клей для обоев" value="Клей для обоев">
                    Клей для обоев
                  </MenuItem>,
                  <MenuItem key="Гидроизоляция" value="Гидроизоляция">
                    Гидроизоляция
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Drywall and components"
              ? [
                  ...
                  <MenuItem key="Профили для ГКЛ" value="Профили для ГКЛ">
                    Профили для ГКЛ
                  </MenuItem>,
                  <MenuItem
                    key="Комплектующие для профилей"
                    value="Комплектующие для профилей"
                  >
                    Комплектующие для профилей
                  </MenuItem>,
                  <MenuItem key="Малярные углы" value="Малярные углы">
                    Малярные углы
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Skirting boards"
              ? [
                  ...
                  <MenuItem key="Потолочные" value="Потолочные">
                    Потолочные
                  </MenuItem>,
                ]
              : null}
            ...
            "Adhesives, sealants and silicones"
              ? [
                  ...
                  <MenuItem key="Герметики" value="Герметики">
                    Герметики
                  </MenuItem>,
                  <MenuItem key="Силиконы" value="Силиконы">
                    Силиконы
                  </MenuItem>,
                  <MenuItem key="ПВА" value="ПВА">
                    ПВА
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Scotch tape, film"
              ? [
                  ...
                  <MenuItem key="Пленка со скотчем" value="Пленка со скотчем">
                    Пленка со скотчем
                  </MenuItem>,
                  <MenuItem
                    key="Полиэтиленовая пленка"
                    value="Полиэтиленовая пленка"
                  >
            ...
            {formik.values.subcategory.category === "Tools"
              ? [
                  <MenuItem key="Ножи и лезвия" value="Ножи и лезвия">
                    Ножи и лезвия
                  </MenuItem>,
                  <MenuItem key="Биты" value="Биты">
                    Биты
                  </MenuItem>,
                  <MenuItem key="Мешки строительные" value="Мешки строительные">
                    Мешки строительные
                  </MenuItem>,
                  <MenuItem key="Шпатели" value="Шпатели">
                    Шпатели
                  </MenuItem>,
                  <MenuItem key="Перчатки" value="Перчатки">
                    Перчатки
                  </MenuItem>,
                  <MenuItem
                    key="Карандаши и маркеры"
                    value="Карандаши и маркеры"
                  >
                    Карандаши и маркеры
                  </MenuItem>,
                ]
            ...
            "Plywood, timber, fiberboard"
              ? [
                  ...
                  <MenuItem key="Брус" value="Брус">
                    Брус
                  </MenuItem>,
                  <MenuItem key="ДВП" value="ДВП">
                    ДВП
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Decorative corners"
              ? [
                  ...
                  <MenuItem key="1*1" value="1*1">
                    1*1
                  </MenuItem>,
                  <MenuItem key="1.5*1.5" value="1.5*1.5">
                    1.5*1.5
                  </MenuItem>,
                  <MenuItem key="2*2" value="2*2">
                    2*2
                  </MenuItem>,
                  <MenuItem key="3*3" value="3*3">
                    3*3
                  </MenuItem>,
                  <MenuItem key="4*4" value="4*4">
                    4*4
                  </MenuItem>,
                  <MenuItem key="Штапик" value="Штапик">
                    Штапик
                  </MenuItem>,
                  <MenuItem key="Галтель" value="Галтель">
                    Галтель
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Thresholds"
              ? [
                  <MenuItem key="Пластиковые" value="Пластиковые">
                    Пластиковые
                  </MenuItem>,
                  <MenuItem key="Алюминиевые" value="Алюминиевые">
                    Алюминиевые
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Wallpaper, fiberglass"
              ? [
                  ...
                  <MenuItem key="Стеклохолст" value="Стеклохолст">
                    Стеклохолст
                  </MenuItem>,
                ]
              : null}
            {formik.values.subcategory.category === "Fasteners"
              ? [
                  <MenuItem key="Саморезы по дереву" value="Саморезы по дереву">
                    Саморезы по дереву
                  </MenuItem>,
                  <MenuItem
                    key="Саморезы по металлу"
                    value="Саморезы по металлу"
                  >
                    Саморезы по металлу
                  </MenuItem>,
                  <MenuItem key="Дюбель-гвоздь" value="Дюбель-гвоздь">
                    Дюбель-гвоздь
                  </MenuItem>,
                  <MenuItem key="Шуруп по бетону" value="Шуруп по бетону">
                    Шуруп по бетону
                  </MenuItem>,
                  <MenuItem key="Анкер-клин" value="Анкер-клин">
                    Анкер-клин
                  </MenuItem>,
                ]
              : null}
