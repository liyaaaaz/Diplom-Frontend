        ...
        <div className="flex flex-1 flex-col justify-center px-6 py-9 lg:px-8 bg-white w-full h-screen">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 className="mt-10 text-center font-bold text-black">    
              <span className=' leading-9 tracking-tight  text-2xl   hover:underline hover:text-green-600'>Вход </span>
              <span className=" mx-4">/</span>
              <span className='text-2xl  hover:underline hover:text-green-600' onClick={handleRegistrationClick}>Регистрация</span>
            </h2>
          </div>
              ...
              <div>
                ...
                <div className="mt-2 text-center">
                  <input
                    ...
                    autoComplete="phone"
                    required
                    className="pl-2 block w-full rounded-md bg-white border-[0.5px] border-black py-1.5 text-gray-900 shadow-sm placeholder:text-green-600 placeholder:ml-3 placeholder:text-lg  sm:text-sm sm:leading-6"  pattern="+7 ([0-9]){3}-[0-9]{3}-[0-9]{2}-[0-9]{2}" placeholder="+7 (9__) - ___ - __ - __"
                  />
                </div>
              </div>
