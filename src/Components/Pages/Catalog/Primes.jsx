...
const filterOptions = [
  ...
  { value: "concretecontact", label: "Только бетоноконтакт" },
  { value: "impregnation", label: "Только пропитка" },
];
        ...
        .filter((product) => {
          switch (filterOption) {
            case "price":
              return true;
            case "primers":
              return product.subcategory.name === "Грунтовка";
            case "concretecontact":
              return product.subcategory.name === "Бетоноконтакт";
            case "impregnation":
                return product.subcategory.name === "Пропитка";
            default:
              return true;
          }
        })
